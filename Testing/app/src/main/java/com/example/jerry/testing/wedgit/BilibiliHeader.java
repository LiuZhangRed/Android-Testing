...
import com.example.jerry.testing.ptr.HeaderController;
import com.example.jerry.testing.ptr.HeaderState;
...
public class BilibiliHeader extends View implements HeaderController {
    ...
    private void init()
    {
        ...
        mWhitePaint.setColor(Color.rgb(146,212,230));
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        //画背景
        canvas.drawColor(getResources().getColor(R.color.btn_answer_pressed));
